...
_evidence: /Users/sgrundhoefer/Projects/designSprache/styles/dev-noir.json (full), styles/dev-noir.html (full CSS); Geist light anchors from the sheet's examples; light ladder DERIVED (ASSUMED); contrast computed; /Users/sgrundhoefer/Projects/novalis-legacy/apps/desktop/frontend/package.json (@fontsource-variable/inter)_
