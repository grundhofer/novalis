...
crates/novalis-core/                            # vault fs, atomic save, watcher, cache, search, links, boards, zip containers; NO UI deps, NO strings
...
- Never modify the legacy app: `/Users/sgrundhoefer/Projects/novalis-legacy` and the `legacy` branch are reference only.
