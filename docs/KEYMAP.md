...
| Right-click on a card | The card's context menu: Open Note (with a note), Rename, Edit Description, Delete Card, Move to Column ▸ the board's other columns (ADR-0032) | board |
